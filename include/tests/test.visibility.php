...
// ---------------------------------------------------------------------
// Stubs. VisibilityConstraint only ever asks a form for a field, and a
// field for its form, cleaned value, visibility and widget.
// ---------------------------------------------------------------------
 ...
 * Serializable and pulls in the query compiler.
 */
class Q {
